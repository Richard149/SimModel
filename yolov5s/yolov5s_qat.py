...
class YOLOv5s_Q(nn.Module):
    def __init__(self, num_classes=80, num_anchors=3):
        super(YOLOv5s_Q, self).__init__()
    ...
    def forward(self, x):
        ...
        out_layer_0 = self.dequant(out_layer_0)
        out_layer_1 = self.dequant(out_layer_1)
        out_layer_2 = self.dequant(out_layer_2)
